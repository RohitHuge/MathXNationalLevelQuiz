...
import { Play, Pause, RotateCcw, ChevronRight, Eye, Plus, Minus, Settings2, Trophy, MonitorUp, List, Clock } from 'lucide-react';
...
export default function AdminDashboard() {
    ...
    const { teams, activeQuestion, showAnswer, isTimerRunning, currentTeamFor, showLeaderboard, isWaitingForQuestion } = gameState;
                ...
                <div className="col-span-12 lg:col-span-4 flex flex-col gap-6 h-full">
                    ...
                    <div className="bg-white/5 p-6 rounded-2xl border border-white/10 flex flex-col gap-4 flex-1">
                        ...
                        <button
                            ...
                            className={`p-4 rounded-xl font-bold flex items-center justify-between border-2 transition-all cursor-pointer ${isWaitingForQuestion ? 'bg-neon-purple/20 border-neon-purple text-neon-purple shadow-[0_0_15px_rgba(157,0,255,0.5)]' : 'bg-black/30 border-white/10 text-white/70 hover:border-white/30 hover:text-white'}`}
                        >
