...
export default function FastFingersDashboard({ user }) {
        ...
        >
            ...
            >
                ...
                <h1 className="text-center mb-2">
                    <span
                        className="block text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight leading-none"
                        style={{
                            background:
                                "linear-gradient(120deg, #ffffff 0%, #d1d5db 25%, #22d3ee 55%, #a855f7 85%)",
                            backgroundSize: "220% 220%",
                            WebkitBackgroundClip: "text",
                            WebkitTextFillColor: "transparent",
                            animation: "gradientShift 5s ease-in-out infinite",
                            filter:
                                "drop-shadow(0 0 35px rgba(34, 211, 238, 0.55)) drop-shadow(0 0 55px rgba(168, 85, 247, 0.45))",
                        }}
                    >
                        FASTEST FINGER
                    </span>
                ...
                {/* Year badge */}
                <div className="mt-4 mb-8 px-6 py-2 rounded-full border border-[#22d3ee]/50 bg-gradient-to-r from-[#1f2937]/80 via-[#1f2937]/60 to-[#0f172a]/80 backdrop-blur-sm shadow-[0_0_25px_rgba(168,85,247,0.25)]">
